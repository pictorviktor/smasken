...
# print(train.info())
# print(train.head())
x_train = trainingSet.copy().drop(columns=['Lead','Number of male actors', 'Number of female actors', 
'Mean Age Male', 'Mean Age Female'])
y_train = trainingSet['Lead']
x_test = testSet.copy().drop(columns=['Lead','Number of male actors', 'Number of female actors', 
'Mean Age Male', 'Mean Age Female'])
y_test = testSet['Lead']
